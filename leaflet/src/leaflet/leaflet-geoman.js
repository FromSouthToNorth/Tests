(() => {
  var t = {
    9705: (t, e, i) => {
      ...
      function s(t, e) {
        var i, n, r, a, o, s, l, h, u, c, p = 0, d = 'FeatureCollection' === t.type, f = 'Feature' === t.type,
      ...
      e.coordAll = function(t) {
        ...
        var i, r = e.featureIndex || 0, a = e.multiFeatureIndex || 0, o = e.geometryIndex || 0, s = e.coordIndex || 0,
          l = e.properties;
        switch (t.type) {
          case'FeatureCollection':
        ...
        if (e = e || {}, !n.isObject(e)) throw new Error('options is invalid');
        var i, r = e.featureIndex || 0, a = e.multiFeatureIndex || 0, o = e.geometryIndex || 0, s = e.segmentIndex || 0,
          l = e.properties;
        switch (t.type) {
          case'FeatureCollection':
            r < 0 && (r = t.features.length + r), l = l || t.features[r].properties, i = t.features[r].geometry;
      ...
      const b = {
        _globalEditModeEnabled: !1, enableGlobalEditMode: function(t) {
          var e = y({}, t);
          this._globalEditModeEnabled = !0, this.Toolbar.toggleButton('editMode', this.globalEditModeEnabled()), L.PM.Utils.findLayers(this.map)
            .forEach((function(t) {
              t.pm.enable(e);
          ...
          this._globalEditModeEnabled = !1, L.PM.Utils.findLayers(this.map)
            .forEach((function(t) {
              t.pm.disable();
      ...
      const k = {
        _globalDragModeEnabled: !1, enableGlobalDragMode: function() {
      ...
      const M = {
        _globalRemovalModeEnabled: !1, enableGlobalRemovalMode: function() {
          var t = this;
      ...
      const x = {
        _globalRotateModeEnabled: !1, enableGlobalRotateMode: function() {
          var t = this;
          this._globalRotateModeEnabled = !0, L.PM.Utils.findLayers(this.map)
            .filter((function(t) {
          ...
          this._globalRotateModeEnabled = !1, L.PM.Utils.findLayers(this.map)
            .filter((function(t) {
              return t instanceof L.Polyline;
            }))
            .forEach((function(t) {
      ...
      var E = {
        _fireDrawStart: function() {
          ...
          var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'Draw',
            e = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
            i = 'Draw' === t ? this._layer : undefined, n = 'Draw' !== t ? this._layer : undefined;
      ...
      const S = E;
      const O = {
        _lastEvents: { keydown: undefined, keyup: undefined, current: undefined }, _initKeyListener: function(t) {
      ...
      var D = i(7361), B = i.n(D), R = i(8721), T = i.n(R);
      ...
      function G(t, e, i) {
        ...
        var E = y * r - m * a * g, S = Math.atan2(y * a + m * r * g, (1 - l) * Math.sqrt(b * b + E * E)),
          O = l / 16 * k * (4 + l * (4 - 3 * k)),
      ...
      function N(t, e, i, n) {
        for (var r, a, o = !(arguments.length > 4 && arguments[4] !== undefined) || arguments[4], s = [], l = 0; l < i; l += 1) {
          if (o) r = G(t, 360 * l / i + n, e), a = L.latLng(r.lng, r.lat); else {
            var h = t.lat + Math.cos(2 * l * Math.PI / i) * e, u = t.lng + Math.sin(2 * l * Math.PI / i) * e;
            a = L.latLng(h, u);
          }
          s.push(a);
        }
      ...
      function z(t, e, i, n) {
        var r = function(t, e, i) {
          var n = t.latLngToContainerPoint(e), r = t.latLngToContainerPoint(i),
            a = 180 * Math.atan2(r.y - n.y, r.x - n.x) / Math.PI + 90;
          return a + (a < 0 ? 360 : 0);
        }(t, e, i);
        return function(t, e, i) {
          e = (e + 360) % 360;
          var n = Math.PI / 180, r = 180 / Math.PI, a = 6378137, o = t.lng * n, s = t.lat * n, l = e * n,
            h = Math.sin(s), u = Math.cos(s), c = Math.cos(i / a), p = Math.sin(i / a),
            d = Math.asin(h * c + u * p * Math.cos(l)), f = o + Math.atan2(Math.sin(l) * p * u, c - h * Math.sin(d));
      ...
      function F(t, e) {
        ...
        return function(e, n) {
          ...
          if ('instanceofShape' === t) {
            if (r = s(e.layer)
              .toLowerCase(), a = s(n.layer)
              .toLowerCase(), !r || !a) return 0;
          }
          else {
            if (!e.hasOwnProperty(t) || !n.hasOwnProperty(t)) return 0;
            r = e[t].toLowerCase(), a = n[t].toLowerCase();
          }
          var l = r in o ? o[r] : Number.MAX_SAFE_INTEGER, h = a in o ? o[a] : Number.MAX_SAFE_INTEGER, u = 0;
      ...
      function U(t) {
        ...
        return t instanceof L.Polygon ? L.polygon(e)
          .getLatLngs() : L.polyline(e)
          .getLatLngs();
      }
      ...
      const H = L.Class.extend({
        includes: [b, k, M, x, S], initialize: function(t) {
          ...
          var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'en',
            ...
            i = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'en', n = L.PM.activeLang;
          ...
          var e = this, i = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
            n = i.ignoreShapes || [], r = i.merge || !1;
          ...
          var e = this, i = r()(this.globalOptions, t), n = !1;
          ...
          })), n && this.map.pm.Draw.CircleMarker.enable(), L.PM.Utils.findLayers(this.map)
            .forEach((function(t) {
              t.pm.setOptions(i);
        ...
        }, _touchEventCounter: 0, _addTouchEvents: function(t) {
          ...
          K(this.map)
            ._onMouseMove(this._createMouseEvent('mousemove', t));
        }, _canvasTouchClick: function(t) {
          var e = '';
          'touchstart' === t.type || 'pointerdown' === t.type ? e = 'mousedown' : 'touchend' === t.type || 'pointerup' === t.type ? e = 'mouseup' : 'touchcancel' !== t.type && 'pointercancel' !== t.type || (e = 'mouseup'), e && K(this.map)
            ._onClick(this._createMouseEvent(e, t));
      ...
      const q = L.Control.extend({
        includes: [S], options: { position: 'topleft', disableByOtherButtons: !0 }, initialize: function(t) {
          ...
          var e = this, i = this.options.position.indexOf('right') > -1 ? 'pos-right' : '',
          ...
          var a = L.DomUtil.create('div', 'leaflet-pm-actions-container '.concat(i), n), o = t.actions, s = {
            cancel: {
              text: I('actions.cancel'), onClick: function() {
                this._triggerClick();
              },
            }, finishMode: {
              text: I('actions.finish'), onClick: function() {
                this._triggerClick();
              },
            }, removeLastVertex: {
              text: I('actions.removeLastVertex'), onClick: function() {
                this._map.pm.Draw[t.jsClass]._removeLastVertex();
              },
            }, finish: {
              text: I('actions.finish'), onClick: function(e) {
          ...
          o.forEach((function(n) {
            ...
            var l = L.DomUtil.create('a', 'leaflet-pm-action '.concat(i, ' action-')
              .concat(o), a);
            if (l.setAttribute('role', 'button'), l.setAttribute('tabindex', '0'), l.href = '#', l.innerHTML = r.text, L.DomEvent.disableClickPropagation(l), L.DomEvent.on(l, 'click', L.DomEvent.stop), !t.disabled && r.onClick) {
              L.DomEvent.addListener(l, 'click', (function(i) {
                i.preventDefault();
                var n = '', a = e._map.pm.Toolbar.buttons;
          ...
          var t = '', e = this._map.pm.Toolbar.buttons;
          ...
          if (this._container) {
            var t = 'pm-disabled', e = this.buttonsDomNode.children[0];
      ...
      function Y(t) {
        for (var e = 1; e < arguments.length; e++) {
          ...
          e % 2 ? J(Object(i), !0)
            .forEach((function(e) {
              X(t, e, i[e]);
            })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(i)) : J(Object(i))
            .forEach((function(e) {
              Object.defineProperty(t, e, Object.getOwnPropertyDescriptor(i, e));
            }));
        }
      ...
      const $ = L.Class.extend({
        options: {
        ...
        }, customButtons: [], initialize: function(t) {
          this.init(t);
        }, reinit: function() {
          ...
          if (this.isVisible) {
            ...
            var t = this.getButtons(), e = [];
            for (var i in !1 === this.options.drawControls && (e = e.concat(Object.keys(t)
              .filter((function(e) {
                return !t[e]._button.tool;
              })))), !1 === this.options.editControls && (e = e.concat(Object.keys(t)
              .filter((function(e) {
                return 'edit' === t[e]._button.tool;
              })))), !1 === this.options.optionsControls && (e = e.concat(Object.keys(t)
              .filter((function(e) {
                return 'options' === t[e]._button.tool;
              })))), !1 === this.options.customControls && (e = e.concat(Object.keys(t)
              .filter((function(e) {
          ...
          return e = Y(Y({}, this.buttons[i]._button), e), { drawInstance: n, control: this.createCustomControl(e) };
          ...
          }), !1 !== t.toggle && (t.toggle = !0), t.block && (t.block = t.block.toLowerCase()), t.block && 'draw' !== t.block || (t.block = ''), t.className ? -1 === t.className.indexOf('control-icon') && (t.className = 'control-icon '.concat(t.className)) : t.className = 'control-icon';
          var n = {
            tool: t.block,
          ...
          var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [], e = this._shapeMapping(),
            i = [];
          t.forEach((function(t) {
            e[t] ? i.push(e[t]) : i.push(t);
          }));
          var n = this.getButtons(), r = {};
      ...
      var et = {
        _initSnappableMarkers: function() {
          ...
          var o = this.options.snapDistance, s = {
            marker: i,
            shape: this._shape,
            snapLatLng: r,
            segment: n.segment,
          ...
          var e = t.layer, i = this._snapList.findIndex((function(t) {
          ...
          var i = this, n = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1, r = [], a = {};
          ...
          var i = this._map, n = e instanceof L.Marker || e instanceof L.CircleMarker, r = e instanceof L.Polygon,
            a = t;
          if (n) {
            var o = e.getLatLng();
          ...
          var n, r, a, o = this, s = arguments.length > 3 && arguments[3] !== undefined && arguments[3],
            l = function u(e) {
          ...
          var i = ['Marker', 'CircleMarker', 'Circle', 'Line', 'Polygon', 'Rectangle'],
            n = this._map.pm.globalOptions.snappingOrder || [], r = 0, a = {};
          return n.concat(i)
            .forEach((function(t) {
              a[t] || (r += 1, a[t] = r);
            })), t.sort(F('instanceofShape', a)), 1 === e ? t[0] || {} : t.slice(0, e);
        }, _checkPrioritiySnapping: function(t) {
          var e = this._map, i = t.segment[0], n = t.segment[1], r = t.latlng, a = this._getDistance(e, i, r),
            o = this._getDistance(e, n, r), s = a < o ? i : n, l = a < o ? a : o;
          if (this.options.snapMiddle) {
            var h = L.PM.Utils.calcMiddleLatLng(e, i, n), u = this._getDistance(e, h, r);
            u < a && u < o && (s = h, l = u);
          }
          ...
          var a = t.project(e, r), o = t.project(i, r), s = t.project(n, r),
            l = L.LineUtil.closestPointOnSegment(a, o, s);
          return t.unproject(l, r);
        }, _getDistanceToSegment: function(t, e, i, n) {
          var r = t.latLngToLayerPoint(e), a = t.latLngToLayerPoint(i), o = t.latLngToLayerPoint(n);
          return L.LineUtil.pointToSegmentDistance(r, a, o);
        }, _getDistance: function(t, e, i) {
          return t.latLngToLayerPoint(e)
            .distanceTo(t.latLngToLayerPoint(i));
        },
      };
      const it = et;
      const nt = L.Class.extend({
        ...
        initialize: function(t) {
          var e = this, i = new L.Icon.Default;
      ...
      nt.Marker = nt.extend({
        initialize: function(t) {
          ...
          if (t.latlng && (!this.options.requireSnapToFinish || this._hintMarker._snapped || this._isFirstLayer())) {
            ...
            var e = this._hintMarker.getLatLng(), i = new L.Marker(e, this.options.markerStyle);
      ...
      function gt(t) {
        var e, i, n = { type: 'FeatureCollection', features: [] };
      ...
      function _t(t, e, i, n, r, a, o, s) {
        var l, h, u, c, p = { x: null, y: null, onLine1: !1, onLine2: !1 };
      ...
      function yt(t) {
        for (var e = 1; e < arguments.length; e++) {
          ...
          e % 2 ? mt(Object(i), !0)
            .forEach((function(e) {
              vt(t, e, i[e]);
            })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(i)) : mt(Object(i))
            .forEach((function(e) {
              Object.defineProperty(t, e, Object.getOwnPropertyDescriptor(i, e));
            }));
        }
      ...
      function bt(t) {
        for (var e = 1; e < arguments.length; e++) {
          ...
          e % 2 ? Lt(Object(i), !0)
            .forEach((function(e) {
              kt(t, e, i[e]);
            })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(i)) : Lt(Object(i))
            .forEach((function(e) {
              Object.defineProperty(t, e, Object.getOwnPropertyDescriptor(i, e));
            }));
        }
      ...
      nt.Line = nt.extend({
        initialize: function(t) {
          ...
          var i = this._layer._defaultShape()
            .slice();
          ...
          if (this.options.allowSelfIntersection || (this._handleSelfIntersection(!0, t.latlng), !this._doesSelfIntersect)) {
            this._hintMarker._snapped || this._hintMarker.setLatLng(t.latlng);
            var e = this._hintMarker.getLatLng(), i = this._layer.getLatLngs(), n = i[i.length - 1];
          ...
          if (t.length <= 1) this.disable(); else {
            var e = this._layer.getLatLngs(), i = t[t.length - 1], n = L.PM.Utils.findDeepMarkerIndex(t, i).indexPath;
            t.pop(), this._layerGroup.removeLayer(i);
            var r = t[t.length - 1], a = e.indexOf(r.getLatLng());
          ...
          var t = '';
          t = I(this._layer.getLatLngs()
            .flat().length <= 1 ? 'tooltips.continueLine' : 'tooltips.finishLine'), this._hintMarker.setTooltipContent(t);
        }, _change: function(t) {
        ...
        initialize: function(t) {
          ...
          var e = new L.Marker(t, { draggable: !1, icon: L.divIcon({ className: 'marker-icon' }) });
          return this._setPane(e, 'vertexPane'), e._pmTempLayer = !0, this._layerGroup.addLayer(e), this._markers.push(e), 1 === this._layer.getLatLngs()
            .flat().length ? (e.on('click', this._finishShape, this), this._tempSnapLayerIndex = this._otherSnapLayers.push(e) - 1, this.options.snappable && this._cleanupSnapping()) : e.on('click', (function() {
            return 1;
          })), e;
        }, _setTooltipText: function() {
          var t = '';
          t = I(this._layer.getLatLngs()
            .flat().length <= 2 ? 'tooltips.continueLine' : 'tooltips.finishPoly'), this._hintMarker.setTooltipContent(t);
        }, _finishShape: function() {
        ...
        initialize: function(t) {
          ...
          var t = this, e = V(this._startMarker.getLatLng(), this._map), i = V(this._hintMarker.getLatLng(), this._map),
          ...
          this._hintMarker._snapped || this._hintMarker.setLatLng(t.latlng);
          var e = this._hintMarker.getLatLng(), i = this._startMarker.getLatLng();
        ...
        initialize: function(t) {
          ...
          var t = this._centerMarker.getLatLng(), e = this._getNewDestinationOfHintMarker();
          this._hintline.setLatLngs([t, e]);
        }, _syncCircleRadius: function() {
          var t, e = this._centerMarker.getLatLng(), i = this._hintMarker.getLatLng();
          ...
          if (!this.options.requireSnapToFinish || this._hintMarker._snapped || this._isFirstLayer()) {
            this._hintMarker._snapped || this._hintMarker.setLatLng(t.latlng);
            var e, i = this._centerMarker.getLatLng(), n = this._hintMarker.getLatLng();
            ...
            var r = bt(bt({}, this.options.pathOptions), {}, { radius: e }), a = L.circle(i, r);
          ...
          var e = this._centerMarker.getLatLng(), i = e.distanceTo(t);
          ...
          if (this._hintMarker._snapped) {
            var t = this._centerMarker.getLatLng(), e = this._hintMarker.getLatLng(), i = t.distanceTo(e);
        ...
        initialize: function(t) {
          ...
          var t = this._centerMarker.getLatLng(), e = this._hintMarker.getLatLng(), i = this._map.project(t)
            .distanceTo(this._map.project(e));
          ...
          if ((!this.options.requireSnapToFinish || this._hintMarker._snapped || this._isFirstLayer()) && t.latlng && !this._layerIsDragging) {
            this._hintMarker._snapped || this._hintMarker.setLatLng(t.latlng);
            var e = this._hintMarker.getLatLng(), i = L.circleMarker(e, this.options.pathOptions);
          ...
          if (!this.options.requireSnapToFinish || this._hintMarker._snapped || this._isFirstLayer()) {
            this._hintMarker._snapped || this._hintMarker.setLatLng(t.latlng);
            var e = this._centerMarker.getLatLng(), i = this._hintMarker.getLatLng(), n = this._map.project(e)
              .distanceTo(this._map.project(i));
            ...
            var r = xt(xt({}, this.options.pathOptions), {}, { radius: n }), a = L.circleMarker(e, r);
            this._setPane(a, 'layerPane'), this._finishLayer(a), a.addTo(this._map.pm._getContainingLayer()), a.pm && a.pm._updateHiddenPolyCircle(), this._fireCreate(a), this.disable(), this.options.continueDrawing && this.enable();
          }
        }, _getNewDestinationOfHintMarker: function() {
          var t = this._hintMarker.getLatLng();
          if (this.options.editable) {
            if (!this._layerGroup.hasLayer(this._centerMarker)) return t;
            var e = this._centerMarker.getLatLng(), i = this._map.project(e)
              .distanceTo(this._map.project(t));
          ...
          var e = this._centerMarker.getLatLng(), i = this._map.project(e), n = L.point(i.x + t, i.y);
      ...
      function jt(t, e) {
        ...
        var r = i[0][0], a = i[0][1], o = i[1][0], s = i[1][1], l = n[0][0], h = n[0][1], u = n[1][0], c = n[1][1],
          p = (c - h) * (o - r) - (u - l) * (s - a), d = (u - l) * (a - h) - (c - h) * (r - l),
          f = (o - r) * (a - h) - (s - a) * (r - l);
        if (0 === p) return null;
        var g = d / p, _ = f / p;
      ...
      const Gt = function(t, e, i) {
        void 0 === i && (i = {});
        var n = Ct(t), r = Ct(e), a = dt(r[1] - n[1]), o = dt(r[0] - n[0]), s = dt(n[1]), l = dt(r[1]),
      ...
      const Ut = function(t, e) {
        void 0 === e && (e = {});
        var i = e.precision, n = e.coordinates, r = e.mutate;
      ...
      function Vt(t, e, i) {
        ...
        var n = Ct(t), r = Ct(e), a = dt(n[0]), o = dt(r[0]), s = dt(n[1]), l = dt(r[1]),
      ...
      function Kt(t, e, i, n) {
        void 0 === n && (n = {});
        var r = Ct(t), a = dt(r[0]), o = dt(r[1]), s = dt(i), l = ct(e, n.units),
      ...
      const Ht = function(t, e, i) {
        void 0 === i && (i = {});
        var n = st([Infinity, Infinity], { dist: Infinity }), r = 0;
        return Rt(t, (function(t) {
          for (var a = Pt(t), o = 0; o < a.length - 1; o++) {
            ...
            var h = Gt(s, l, i), u = Math.max(s.properties.dist, l.properties.dist), c = Vt(s, l),
              p = Kt(e, u, c + 90, i), d = Kt(e, u, c - 90, i),
      ...
      function Jt(t, e) {
        var i = [], n = Pt(t)[0], r = Pt(t)[t.geometry.coordinates.length - 1];
        if (Xt(n, Ct(e)) || Xt(r, Ct(e))) return ht([t]);
        var a = It(), o = Tt(t);
        a.load(o);
        var s = a.search(e);
        if (!s.features.length) return ht([t]);
        var l = Yt(e, s), h = function(t, e, i) {
          var n = i;
      ...
      function $t(t, e, i) {
        ...
        var n = Ct(t), r = Et(e), a = r.type, o = e.bbox, s = r.coordinates;
        if (o && !1 === function(t, e) {
      ...
      function Wt(t, e, i) {
        ...
        for (var r = 0, a = e.length - 1; r < e.length; a = r++) {
          var o = e[r][0], s = e[r][1], l = e[a][0], h = e[a][1];
      ...
      function Qt(t, e, i, n, r) {
        var a = i[0], o = i[1], s = t[0], l = t[1], h = e[0], u = e[1], c = h - s, p = u - l,
          d = (i[0] - s) * p - (i[1] - l) * c;
        if (null !== r) {
      ...
      function ee(t, e) {
        var i = Et(t), n = Et(e), r = i.type, a = n.type, o = i.coordinates, s = n.coordinates;
        switch (r) {
          case'Point':
            ...
            switch (a) {
              ...
              case'MultiPoint':
                return function(t, e) {
                  for (var i = !1, n = 0, r = e.coordinates; n < r.length; n++) {
                    var a = r[n];
                    if (te(a, t, { ignoreEndVertices: !0 }) && (i = !0), !te(a, t)) return !1;
                  }
                  if (i) return !0;
                  return !1;
                }(i, n);
      ...
      nt.Cut = nt.Polygon.extend({
        initialize: function(t) {
          ...
          if (this._editedLayers = [], (this.options.allowSelfIntersection || (this._handleSelfIntersection(!0, this._layer.getLatLngs()[0]), !this._doesSelfIntersect)) && (!this.options.requireSnapToFinish || this._hintMarker._snapped || this._isFirstLayer())) {
            ...
            if (!(e.length <= 2)) {
              ...
              i._latlngInfos = this._layer._latlngInfo, this.cut(i), this._cleanupSnapping(), this._otherSnapLayers.splice(this._tempSnapLayerIndex, 1), delete this._tempSnapLayerIndex, this._editedLayers.forEach((function(e) {
                var i = e.layer, n = e.originalLayer;
          ...
          var e = this, i = this._map._layers, n = t._latlngInfos || [];
          Object.keys(i)
            .map((function(t) {
              return i[t];
            }))
            ...
            .filter((function(e) {
              try {
                ...
                return i || e instanceof L.Polyline && !(e instanceof L.Polygon) ? i : (n = t.toGeoJSON(15), r = e.toGeoJSON(15), a = le(n), o = le(r), !(0 === (s = oe()
                  .intersection(a.coordinates, o.coordinates)).length || !(1 === s.length ? ue(s[0]) : ce(s))));
              }
              catch (l) {
            ...
            .forEach((function(i) {
              ...
              if (i instanceof L.Polygon) {
                ...
                n.forEach((function(t) {
                  if (t && t.snapInfo) {
                    var i = t.latlng, n = e._calcClosestLayer(i, [r]);
                    if (n && n.segment && n.distance < e.options.snapDistance) {
                      var o = n.segment;
                      if (o && 2 === o.length) {
                        var s = L.PM.Utils._getIndexFromSegment(a, o), l = s.indexPath, h = s.parentPath,
                          u = s.newIndex;
              ...
              var o = e._cutLayer(t, r), s = L.geoJSON(o, i.options);
              ...
              if (h.pm.enable(i.pm.options), h.pm.disable(), i._pmTempLayer = !0, t._pmTempLayer = !0, i.remove(), i.removeFrom(e._map.pm._getContainingLayer()), t.remove(), t.removeFrom(e._map.pm._getContainingLayer()), h.getLayers && 0 === h.getLayers().length && e._map.pm.removeLayer({ target: h }), h instanceof L.LayerGroup ? (h.eachLayer((function(t) {
          ...
          if (e instanceof L.Polygon) n = e.toGeoJSON(15), r = t.toGeoJSON(15), a = le(n), o = le(r), i = 0 === (s = oe()
            .difference(a.coordinates, o.coordinates)).length ? null : 1 === s.length ? ue(s[0]) : ce(s); else {
            var h = de(e);
            h.forEach((function(e) {
              var i = Zt(e, t.toGeoJSON(15));
              (i && i.features.length > 0 ? L.geoJSON(i) : L.geoJSON(e)).getLayers()
                .forEach((function(e) {
        ...
        initialize: function(t) {
          ...
          if (t.latlng && (!this.options.requireSnapToFinish || this._hintMarker._snapped || this._isFirstLayer())) {
            ...
            var a = this._createTextIcon(this.textArea),
              o = new L.Marker(i, { textMarker: !0, _textMarkerOverPM: !0, icon: a });
            if (this._setPane(o, 'markerPane'), this._finishLayer(o), o.pm || (o.options.draggable = !1), o.addTo(this._map.pm._getContainingLayer()), o.pm) {
              var s, l, h, u, c;
              o.pm.textArea = this.textArea, L.setOptions(o.pm, { removeIfEmpty: null === (s = null === (l = this.options.textOptions) || void 0 === l ? void 0 : l.removeIfEmpty) || void 0 === s || s });
      ...
      const ve = {
        enableLayerDrag: function() {
          ...
          var e = t.touches ? t.touches[0] : t, i = { originalEvent: e, target: this._layer };
          ...
          var e = { originalEvent: t.touches ? t.touches[0] : t, target: this._layer };
          ...
          if (!(t.originalEvent.button > 0)) {
            ...
            var e = t._fromLayerSync, i = this._syncLayers('_dragMixinOnMouseDown', t);
          ...
          var e = t.latlng, i = e.lat - this._tempDragCoord.lat, n = e.lng - this._tempDragCoord.lng,
            r = function u(t) {
          ...
          if (this._layer instanceof L.Circle || this._layer instanceof L.CircleMarker && this._layer.options.editable) {
            ...
            var l = r([this._layer.getBounds()
              .getNorthWest(), this._layer.getBounds()
              .getSouthEast()]);
      ...
      var Me = {
        _onRotateStart: function(t) {
          this._preventRenderingMarkers(!0), this._rotationOriginLatLng = this._getRotationCenter()
            .clone(), this._rotationOriginPoint = be(this._map, this._rotationOriginLatLng), this._rotationStartPoint = be(this._map, t.target.getLatLng()), this._initialRotateLatLng = U(this._layer), this._startAngle = this.getAngle();
          ...
          var e = be(this._map, t.target.getLatLng()), i = this._rotationStartPoint, n = this._rotationOriginPoint,
          ...
          var s = 180 * r / Math.PI, l = (s = s < 0 ? s + 360 : s) + this._startAngle;
          ...
          var a = be(r, i);
          return this._matrix = n.clone()
            .rotate(t, a)
            .flip(), Le(e, this._matrix, r);
        }, _setAngle: function(t) {
          t = t < 0 ? t + 360 : t, this._angle = t % 360;
        }, _getRotationCenter: function() {
          var t = L.polygon(this._layer.getLatLngs(), { stroke: !1, fill: !1, pmIgnore: !0 })
          ...
          this.rotateEnabled() && (this._rotatePoly.pm._layerRotated && this._fireUpdate(), this._rotatePoly.pm._layerRotated = !1, this._rotatePoly.pm.disable(), this._rotatePoly.remove(), this._rotatePoly.pm.setOptions({ rotate: !1 }), this._rotatePoly = undefined, this._rotateOrgLatLng = undefined, this._layer.off('remove', this.disableRotate, this), this._rotateEnabled = !1, this._fireRotationDisable(this._layer), this._fireRotationDisable(this._layer._map));
        }, rotateEnabled: function() {
          return this._rotateEnabled;
        }, rotateLayer: function(t) {
          var e = this.getAngle(), i = this._layer.getLatLngs(), n = t * (Math.PI / 180);
          this._layer.setLatLngs(this._rotateLayer(n, this._layer.getLatLngs(), this._getRotationCenter(), L.PM.Matrix.init(), this._layer._map)), this._rotateOrgLatLng = L.polygon(this._layer.getLatLngs())
            .getLatLngs(), this._setAngle(this.getAngle() + t), this.rotateEnabled() && this._rotatePoly && this._rotatePoly.pm.enabled() && (this._rotatePoly.setLatLngs(this._rotateLayer(n, this._rotatePoly.getLatLngs(), this._getRotationCenter(), L.PM.Matrix.init(), this._rotatePoly._map)), this._rotatePoly.pm._initMarkers());
      ...
      const we = L.Class.extend({
        ...
        _vertexValidation: function(t, e) {
          var i = e.target, n = { layer: this._layer, marker: i, event: e }, r = '';
      ...
      we.LayerGroup = L.Class.extend({
        initialize: function(t) {
          ...
          this._layerGroup.on('layeradd', L.Util.throttle((function(t) {
            if (!t.layer._pmTempLayer) {
              ...
              i.forEach((function(t) {
                e._initLayer(t);
              })), i.length > 0 && e._getMap() && e._getMap()
                .pm
                .globalEditModeEnabled() && e.enabled() && e.enable(e.getOptions());
            }
          ...
          var t = arguments.length > 0 && arguments[0] !== undefined && arguments[0],
            e = !(arguments.length > 1 && arguments[1] !== undefined) || arguments[1],
            i = !(arguments.length > 2 && arguments[2] !== undefined) || arguments[2],
            n = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : [], r = [];
          return t ? this._layerGroup.getLayers()
            .forEach((function(t) {
        ...
        _shape: 'Marker', initialize: function(t) {
      ...
      we.Line = we.extend({
        includes: [Ee], _shape: 'Line', initialize: function(t) {
          ...
          var t = this, e = this._map, i = this._layer.getLatLngs();
          ...
          if (!t || !e) return !1;
          var i = L.PM.Utils.calcMiddleLatLng(this._map, t.getLatLng(), e.getLatLng()), n = this._createMarker(i),
          ...
          var n = t.getLatLng(), r = this._layer._latlngs;
          delete t.leftM, delete t.rightM;
          var a = L.PM.Utils.findDeepMarkerIndex(this._markers, e), o = a.indexPath, s = a.index, l = a.parentPath,
            h = o.length > 1 ? B()(r, l) : r, u = o.length > 1 ? B()(this._markers, l) : this._markers;
          ...
          if (this.hasSelfIntersection()) {
            ...
            t ? this._flashLayer() : (e.setStyle({ color: '#f00000ff' }), this.isRed = !0), this._fireIntersect(gt(this._layer.toGeoJSON(15)));
          }
          ...
          var t = this;
          this.cachedColor || (this.cachedColor = this._layer.options.color), this._layer.setStyle({ color: '#f00000ff' }), this.isRed = !0, window.setTimeout((function() {
          ...
          if (this._vertexValidation('remove', t)) {
            ...
            var i = this._layer.getLatLngs(), n = L.PM.Utils.findDeepMarkerIndex(this._markers, e), r = n.indexPath,
              a = n.index, o = n.parentPath;
            if (r) {
              var s = r.length > 1 ? B()(i, o) : i, l = r.length > 1 ? B()(this._markers, o) : this._markers;
          ...
          var e = this._layer.getLatLngs(), i = t.getLatLng(), n = L.PM.Utils.findDeepMarkerIndex(this._markers, t),
            r = n.indexPath, a = n.index, o = n.parentPath;
          (r.length > 1 ? B()(e, o) : e).splice(a, 1, i), this._layer.setLatLngs(e);
        }, _getNeighborMarkers: function(t) {
          var e = L.PM.Utils.findDeepMarkerIndex(this._markers, t), i = e.indexPath, n = e.index, r = e.parentPath,
            a = i.length > 1 ? B()(this._markers, r) : this._markers, o = (n + 1) % a.length;
          return { prevMarker: a[(n + (a.length - 1)) % a.length], nextMarker: a[o] };
        }, _checkMarkerAllowedToDrag: function(t) {
          var e = this._getNeighborMarkers(t), i = e.prevMarker, n = e.nextMarker,
            r = L.polyline([i.getLatLng(), t.getLatLng()]), a = L.polyline([t.getLatLng(), n.getLatLng()]),
          ...
          if (this._vertexValidationDrag(e)) {
            var i = L.PM.Utils.findDeepMarkerIndex(this._markers, e), n = i.indexPath, r = i.index, a = i.parentPath;
            if (n) {
              ...
              var o = n.length > 1 ? B()(this._markers, a) : this._markers, s = (r + 1) % o.length,
                l = (r + (o.length - 1)) % o.length, h = e.getLatLng(), u = o[l].getLatLng(), c = o[s].getLatLng();
          ...
          if (this._vertexValidationDragEnd(e)) {
            var i = L.PM.Utils.findDeepMarkerIndex(this._markers, e).indexPath, n = this.hasSelfIntersection();
        ...
        _shape: 'Polygon', _checkMarkerAllowedToDrag: function(t) {
          var e = this._getNeighborMarkers(t), i = e.prevMarker, n = e.nextMarker,
            r = L.polyline([i.getLatLng(), t.getLatLng()]), a = L.polyline([t.getLatLng(), n.getLatLng()]),
            o = At(this._layer.toGeoJSON(15), r.toGeoJSON(15)).features.length,
            s = At(this._layer.toGeoJSON(15), a.toGeoJSON(15)).features.length;
        ...
        _shape: 'Rectangle', _initMarkers: function() {
          var t = this, e = this._map, i = this._findCorners();
          ...
          if (this._vertexValidation('move', t)) {
            var e = t.target, i = this._cornerMarkers;
        ...
        _shape: 'Circle', initialize: function(t) {
          ...
          var e = this._layer.getLatLng(), i = this._layer._radius, n = this._getLatLngOnCircle(e, i);
          ...
          var i = t.getLatLng(), n = e.getLatLng();
          ...
          if (!t.target._cancelDragEventChain) {
            ...
            var i = this._layer._radius, n = this._getLatLngOnCircle(e, i);
          ...
          var t = this._centerMarker.getLatLng(), e = this._outerMarker.getLatLng(), i = this._map.distance(t, e);
          ...
          var t = this._centerMarker.getLatLng(), e = this._outerMarker.getLatLng();
          this._hintline.setLatLngs([t, e]);
        }, _disableSnapping: function() {
          var t = this;
          ...
          this._hiddenPolyCircle ? this._hiddenPolyCircle.setLatLngs(L.PM.Utils.circleToPolygon(this._layer, 200, !t)
            .getLatLngs()) : this._hiddenPolyCircle = L.PM.Utils.circleToPolygon(this._layer, 200, !t), this._hiddenPolyCircle._parentCopy || (this._hiddenPolyCircle._parentCopy = this._layer);
        }, _getLatLngOnCircle: function(t, e) {
          var i = this._map.project(t), n = L.point(i.x + e, i.y);
          return this._map.unproject(n);
        ...
        _shape: 'CircleMarker', initialize: function(t) {
          this._layer = t, this._enabled = !1, this._updateHiddenPolyCircle();
        }, enable: function() {
          ...
          var e = this._layer._radius, i = this._getLatLngOnCircle(t, e);
          ...
          var t = this._layer.getLatLng(), e = this._layer._radius, i = this._getLatLngOnCircle(t, e);
          this._outerMarker.setLatLng(i), this._centerMarker.setLatLng(t), this._syncHintLine(), this._updateHiddenPolyCircle();
        }, _resizeCircle: function() {
          this._outerMarker.setLatLng(this._getNewDestinationOfOuterMarker()), this._syncHintLine(), this._syncCircleRadius();
        }, _syncCircleRadius: function() {
          var t = this._centerMarker.getLatLng(), e = this._outerMarker.getLatLng(), i = this._map.project(t)
            .distanceTo(this._map.project(e));
          ...
          if (t) {
            ...
            this._hiddenPolyCircle ? this._hiddenPolyCircle.setLatLngs(L.PM.Utils.circleToPolygon(i, 200, !n)
              .getLatLngs()) : this._hiddenPolyCircle = L.PM.Utils.circleToPolygon(i, 200, !n), this._hiddenPolyCircle._parentCopy || (this._hiddenPolyCircle._parentCopy = this._layer);
          }
        }, _getNewDestinationOfOuterMarker: function() {
          var t = this._centerMarker.getLatLng(), e = this._outerMarker.getLatLng(), i = this._map.project(t)
            .distanceTo(this._map.project(e));
        ...
        _shape: 'ImageOverlay', initialize: function(t) {
          this._layer = t, this._enabled = !1;
        }, toggleEdit: function(t) {
          this.enabled() ? this.disable() : this.enable(t);
        }, enabled: function() {
        ...
        _shape: 'Text', initialize: function(t) {
          this._layer = t, this._enabled = !1;
        }, enable: function(t) {
          ...
          var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {}, e = this._hasFocus;
      ...
      Re.init = function() {
        ...
        transform: function(t) {
          ...
          var e = this._matrix, i = t.x, n = t.y;
          ...
          return t === undefined ? new L.Point(this._matrix[0], this._matrix[3]) : (e = e || L.point(0, 0), 'number' == typeof t ? (i = t, n = t) : (i = t.x, n = t.y), this._add(i, 0, 0, n, e.x, e.y)
            ._add(1, 0, 0, 1, -e.x, -e.y));
          var i, n;
        }, rotate: function(t, e) {
          var i = Math.cos(t), n = Math.sin(t);
          return e = e || new L.Point(0, 0), this._add(i, n, -n, i, e.x, e.y)
            ._add(1, 0, 0, 1, -e.x, -e.y);
        }, flip: function() {
          return this._matrix[1] *= -1, this._matrix[2] *= -1, this;
        }, _add: function(t, e, i, n, r, a) {
          var o, s = [[], [], []], l = this._matrix, h = [[l[0], l[2], l[4]], [l[1], l[3], l[5]], [0, 0, 1]],
            u = [[t, i, r], [e, n, a], [0, 0, 1]];
      ...
      var Ie = {
        calcMiddleLatLng: function(t, e, i) {
          var n = t.project(e), r = t.project(i);
          return t.unproject(n._add(r)
            ._divideBy(2));
          ...
          t.fire(e, i, n);
          var r = this.getAllParentGroups(t), a = r.groups;
          a.forEach((function(t) {
            t.fire(e, i, n);
          }));
          ...
          }(t), t._pmLastGroupFetch = { time: (new Date).getTime(), groups: i, groupIds: e }, {
            groupIds: e,
            groups: i,
          }) : { groups: t._pmLastGroupFetch.groups, groupIds: t._pmLastGroupFetch.groupIds };
        }, createGeodesicPolygon: N, getTranslation: I, findDeepCoordIndex: function(t, e) {
          var i, n = !(arguments.length > 2 && arguments[2] !== undefined) || arguments[2], r = function o(t) {
            return function(r, a) {
              var s = t.concat(a);
              if (n) {
                if (r.lat && r.lat === e.lat && r.lng === e.lng) return i = s, !0;
              }
              else if (r.lat && L.latLng(r)
                .equals(e)) return i = s, !0;
          ...
          if (e && 2 === e.length) {
            var i = this.findDeepCoordIndex(t, e[0]), n = this.findDeepCoordIndex(t, e[1]),
          ...
          var r = be(n, t), a = be(n, e), o = i * Math.PI / 180, s = Math.cos(o), l = Math.sin(o),
            h = (a.x - r.x) * s + (a.y - r.y) * l, u = (a.y - r.y) * s - (a.x - r.x) * l, c = h * s + r.x,
            p = h * l + r.y, d = -u * l + r.x, f = u * s + r.y;
          return [ke(n, r), ke(n, { x: c, y: p }), ke(n, a), ke(n, { x: d, y: f })];
        }, pxRadiusToMeterRadius: function(t, e, i) {
          var n = e.project(i), r = L.point(n.x + t, n.y);
      ...
      Array.prototype.findIndex = Array.prototype.findIndex || function(t) {
        ...
        value: function(t, e) {
          ...
          if (0 === n) return !1;
          var r, a, o = 0 | e, s = Math.max(o >= 0 ? o : n - Math.abs(o), 0);
          for (; s < n;) {
      ...
      var n = i(2582), r = i(4102), a = i(1540), o = i(9705).Z, s = a.featureEach,
      ...
      var n = i(1789), r = i(401), a = i(7667), o = i(1327), s = i(1866);
      ...
      var n = i(7040), r = i(4125), a = i(2117), o = i(7518), s = i(4705);
      ...
      var n = i(4785), r = i(1285), a = i(6e3), o = i(9916), s = i(5265);
      ...
      var n = i(8407), r = i(7465), a = i(3779), o = i(7599), s = i(4758), l = i(4309);
      ...
      var n = i(2545), r = i(5694), a = i(1469), o = i(4144), s = i(5776), l = i(6719),
        h = Object.prototype.hasOwnProperty;
      t.exports = function(t, e) {
        var i = a(t), u = !i && r(t), c = !i && !u && o(t), p = !i && !u && !c && l(t), d = i || u || c || p,
          f = d ? n(t.length, String) : [], g = f.length;
      ...
      var n = i(9465), r = i(7813);
      t.exports = function(t, e, i) {
        (i !== undefined && !r(t[e], i) || i === undefined && !(e in t)) && n(t, e, i);
      };
    }, 4865: (t, e, i) => {
      var n = i(9465), r = i(7813), a = Object.prototype.hasOwnProperty;
      t.exports = function(t, e, i) {
        var o = t[e];
      ...
      var n = i(3218), r = Object.create, a = function() {
        function t() {
        }
      ...
      var n = i(1811), r = i(327);
      t.exports = function(t, e) {
        for (var i = 0, a = (e = n(e, t)).length; null != t && i < a;) t = t[r(e[i++])];
        return i && i == a ? t : undefined;
      };
    }, 4239: (t, e, i) => {
      var n = i(2705), r = i(9607), a = i(2333), o = n ? n.toStringTag : undefined;
      ...
      var n = i(4239), r = i(7005);
      t.exports = function(t) {
        return r(t) && '[object Arguments]' == n(t);
      };
    }, 8458: (t, e, i) => {
      var n = i(3560), r = i(5346), a = i(3218), o = i(346), s = /^\[object .+?Constructor\]$/, l = Function.prototype,
        h = Object.prototype, u = l.toString, c = h.hasOwnProperty, p = RegExp('^' + u.call(c)
          .replace(/[\\^$.*+?()[\]{}|]/g, '\\$&')
      ...
      var n = i(6384), r = i(6556), a = i(8483), o = i(9783), s = i(3218), l = i(1704), h = i(6390);
      ...
      var n = i(6556), r = i(4626), a = i(7133), o = i(278), s = i(8517), l = i(5694), h = i(1469), u = i(9246),
        c = i(4144), p = i(3560), d = i(3218), f = i(8630), g = i(6719), _ = i(6390), m = i(9881);
      t.exports = function(t, e, i, y, v, L, b) {
        var k = _(t, i), M = _(e, i), x = b.get(M);
        if (x) n(t, i, x); else {
          var w = L ? L(k, M, i + '', t, e, b) : undefined, C = w === undefined;
          if (C) {
      ...
      var n = i(6557), r = i(5357), a = i(61);
      t.exports = function(t, e) {
        return a(r(t, e, n), t + '');
      };
    }, 6560: (t, e, i) => {
      var n = i(5703), r = i(8777), a = i(6557), o = r ? function(t, e) {
      ...
      var n = i(2705), r = i(9932), a = i(1469), o = i(3448), s = n ? n.prototype : undefined,
      ...
      var n = i(1469), r = i(5403), a = i(5514), o = i(9833);
      t.exports = function(t, e) {
      ...
      t = i.nmd(t);
      var n = i(5639), r = e && !e.nodeType && e, a = r && t && !t.nodeType && t,
        o = a && a.exports === r ? n.Buffer : undefined, s = o ? o.allocUnsafe : undefined;
      t.exports = function(t, e) {
        if (e) return t.slice();
        var i = t.length, n = s ? s(i) : new t.constructor(i);
        return t.copy(n), n;
      };
    }, 7133: (t, e, i) => {
      var n = i(4318);
      ...
      var n = i(4865), r = i(9465);
      t.exports = function(t, e, i, a) {
        var o = !i;
        i || (i = {});
        for (var s = -1, l = e.length; ++s < l;) {
          var h = e[s], u = a ? a(i[h], t[h], h, i, t) : undefined;
      ...
      var n = i(5976), r = i(6612);
      t.exports = function(t) {
        return n((function(e, i) {
          var n = -1, a = i.length, o = a > 1 ? i[a - 1] : undefined, s = a > 2 ? i[2] : undefined;
      ...
      var n = i(2705), r = Object.prototype, a = r.hasOwnProperty, o = r.toString, s = n ? n.toStringTag : undefined;
      t.exports = function(t) {
        var e = a.call(t, s), i = t[s];
        try {
          t[s] = undefined;
          var n = !0;
        }
      ...
      var n = i(1811), r = i(5694), a = i(1469), o = i(5776), s = i(1780), l = i(327);
      t.exports = function(t, e, i) {
      ...
      var n = i(4536), r = Object.prototype.hasOwnProperty;
      t.exports = function(t) {
        var e = this.__data__;
        if (n) {
          var i = e[t];
      ...
      var n = i(3118), r = i(5924), a = i(5726);
      t.exports = function(t) {
      ...
      var n = i(7813), r = i(8612), a = i(5776), o = i(3218);
      t.exports = function(t, e, i) {
        if (!o(i)) return !1;
        var s = typeof e;
      ...
      var n = i(1469), r = i(3448), a = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, o = /^\w*$/;
      t.exports = function(t, e) {
        if (n(t)) return !1;
        var i = typeof t;
      ...
      var n, r = i(4429), a = (n = /[^.]+$/.exec(r && r.keys && r.keys.IE_PROTO || '')) ? 'Symbol(src)_1.' + n : '';
      t.exports = function(t) {
        return !!a && a in t;
      };
    }, 5726: t => {
      ...
      var n = i(8470), r = Array.prototype.splice;
      t.exports = function(t) {
      ...
      var n = i(8470);
      t.exports = function(t, e) {
        var i = this.__data__, r = n(i, t);
        return r < 0 ? (++this.size, i.push([t, e])) : i[r][1] = e, this;
      };
    }, 4785: (t, e, i) => {
      var n = i(1989), r = i(8407), a = i(7071);
      t.exports = function() {
      ...
      t = i.nmd(t);
      var n = i(1957), r = e && !e.nodeType && e, a = r && t && !t.nodeType && t, o = a && a.exports === r && n.process,
        s = function() {
          try {
      ...
      var n = i(1957), r = 'object' == typeof self && self && self.Object === Object && self,
      ...
      var n = i(8407), r = i(7071), a = i(3369);
      t.exports = function(t, e) {
        var i = this.__data__;
        if (i instanceof n) {
          var o = i.__data__;
      ...
      var n = i(9454), r = i(7005), a = Object.prototype, o = a.hasOwnProperty, s = a.propertyIsEnumerable,
        l = n(function() {
          return arguments;
        }()) ? n : function(t) {
      ...
      var n = i(3560), r = i(1780);
      t.exports = function(t) {
        return null != t && r(t.length) && !n(t);
      };
    }, 9246: (t, e, i) => {
      var n = i(8612), r = i(7005);
      t.exports = function(t) {
        return r(t) && n(t);
      };
    }, 4144: (t, e, i) => {
      t = i.nmd(t);
      var n = i(5639), r = i(5062), a = e && !e.nodeType && e, o = a && t && !t.nodeType && t,
        s = o && o.exports === a ? n.Buffer : undefined, l = (s ? s.isBuffer : undefined) || r;
      t.exports = l;
    }, 3560: (t, e, i) => {
      var n = i(4239), r = i(3218);
      t.exports = function(t) {
        if (!r(t)) return !1;
        var e = n(t);
      ...
      var n = i(4239), r = i(5924), a = i(7005), o = Function.prototype, s = Object.prototype, l = o.toString,
        h = s.hasOwnProperty, u = l.call(Object);
      t.exports = function(t) {
      ...
      var n = i(8749), r = i(1717), a = i(1167), o = a && a.isTypedArray, s = o ? r(o) : n;
      t.exports = s;
    }, 1704: (t, e, i) => {
      var n = i(4636), r = i(313), a = i(8612);
      t.exports = function(t) {
      ...
      var n = i(2980), r = i(1463)((function(t, e, i) {
        n(t, e, i);
      }));
      t.exports = r;
    }, 5062: t => {
      ...
      t.exports = function() {
        ...
        var u = function() {
          ...
          return t.prototype.insert = function(t, e) {
            ...
            var r = this._comparator, o = a(t, this._root, r), s = r(t, o.key);
            ...
            var n = t.length, r = this._comparator;
            ...
            var n = this._comparator, r = s(t, this._root, n), a = r.left, h = r.right;
        ...
        function c(t, e, i, r) {
          var a = r - i;
          if (a > 0) {
            var o = i + Math.floor(a / 2), s = t[o], l = e[o], h = new n(s, l);
        ...
        function f(t, e, i) {
          var n = i - e;
          if (n > 0) {
            var r = e + Math.floor(n / 2), a = f(t, e, r), o = t.head;
        ...
        var m = function(t, e) {
          ...
          var i = t.ll.x < e.ll.x ? e.ll.x : t.ll.x, n = t.ur.x < e.ur.x ? t.ur.x : e.ur.x;
          return {
        ...
        var L = v * v, b = function(t, e) {
            ...
            return i(e, [{
              key: 'round', value: function(t) {
                var e = this.tree.add(t), i = this.tree.prev(e);
          ...
          }(), x = new k, w = function(t, e) {
            return t.x * e.y - t.y * e.x;
          }, C = function(t, e) {
            return t.x * e.x + t.y * e.y;
          }, P = function(t, e, i) {
            var n = { x: e.x - t.x, y: e.y - t.y }, r = { x: i.x - t.x, y: i.y - t.y }, a = w(n, r);
            return b(a, 0);
          }, E = function(t) {
            return Math.sqrt(C(t, t));
          }, S = function(t, e, i) {
            var n = { x: e.x - t.x, y: e.y - t.y }, r = { x: i.x - t.x, y: i.y - t.y };
            ...
            var r = w(e, n);
            if (0 == r) return null;
            var a = { x: i.x - t.x, y: i.y - t.y }, o = w(a, e) / r, s = w(a, n) / r;
            ...
            return i(e, null, [{
              ...
              key: 'getLeftmostComparator', value: function(t) {
                var e = this, i = new Map, n = function(n) {
                  var r = n.otherSE;
                  i.set(n, { sine: S(e.point, t.point, r.point), cosine: O(e.point, t.point, r.point) });
                };
                return function(t, e) {
                  i.has(t) || n(t), i.has(e) || n(e);
                  var r = i.get(t), a = r.sine, o = r.cosine, s = i.get(e), l = s.sine, h = s.cosine;
            ...
            return i(e, null, [{
              key: 'compare', value: function(t, e) {
                var i = t.leftSE.point.x, n = e.leftSE.point.x, r = t.rightSE.point.x, a = e.rightSE.point.x;
                if (a < i) return 1;
                if (r < n) return -1;
                var o = t.leftSE.point.y, s = e.leftSE.point.y, l = t.rightSE.point.y, h = e.rightSE.point.y;
                if (i < n) {
                  if (s < o && s < l) return 1;
                  if (s > o && s > l) return -1;
              ...
              key: 'comparePoint', value: function(t) {
                ...
                var e = this.leftSE.point, i = this.rightSE.point, n = this.vector();
                if (e.x === i.x) return t.x === e.x ? 0 : t.x < e.x ? 1 : -1;
                var r = (t.y - e.y) / n.y, a = e.x + r * n.x;
                if (t.x === a) return 0;
                var o = (t.x - e.x) / n.x, s = e.y + o * n.y;
                return t.y === s ? 0 : t.y < s ? -1 : 1;
              },
            }, {
              key: 'getIntersection', value: function(t) {
                var e = this.bbox(), i = t.bbox(), n = y(e, i);
                if (null === n) return null;
                var r = this.leftSE.point, a = this.rightSE.point, o = t.leftSE.point, s = t.rightSE.point,
                  l = m(e, o) && 0 === this.comparePoint(o), h = m(i, r) && 0 === t.comparePoint(r),
                  u = m(e, s) && 0 === this.comparePoint(s), c = m(i, a) && 0 === t.comparePoint(a);
              ...
              key: 'split', value: function(t) {
                var i = [], n = t.events !== undefined, r = new T(t, !0), a = new T(t, !1), o = this.rightSE;
              ...
              key: 'consume', value: function(t) {
                ...
                if (0 !== r) {
                  ...
                  for (var s = 0, l = n.rings.length; s < l; s++) {
                    var h = n.rings[s], u = n.windings[s], c = i.rings.indexOf(h);
              ...
              key: 'afterState', value: function() {
                ...
                for (var e = this._afterState.rings, i = this._afterState.windings, n = this._afterState.multiPolys, r = 0, a = this.rings.length; r < a; r++) {
                  var o = this.rings[r], s = this.windings[r], l = e.indexOf(o);
              ...
              key: 'fromRing', value: function(t, i, n) {
            ...
            return i(e, null, [{
                ...
                for (var i = [], n = 0, r = t.length; n < r; n++) {
                  ...
                  if (a.isInResult() && !a.ringOut) {
                    for (var o = null, s = a.leftSE, l = a.rightSE, h = [s], u = s.point, c = []; o = s, s = l, h.push(s), s.point !== u;) for (; ;) {
                      ...
                      if (0 === p.length) {
                        var d = h[0].point, f = h[h.length - 1].point;
                        throw new Error('Unable to complete output ring starting at ['.concat(d.x, ',') + ' '.concat(d.y, ']. Last matching segment found ends at') + ' ['.concat(f.x, ', ')
                          .concat(f.y, '].'));
                      }
                      if (1 === p.length) {
                        l = p[0].otherSE;
                      ...
                      var v = c.splice(g)[0], L = h.splice(v.index);
              ...
              key: 'getGeom', value: function() {
                for (var t = this.events[0].point, e = [t], i = 1, n = this.events.length - 1; i < n; i++) {
                  var r = this.events[i].point, a = this.events[i + 1].point;
            ...
            return i(e, [{
              key: 'process', value: function(t) {
                ...
                if (!n) throw new Error('Unable to find segment #'.concat(e.id, ' ') + '['.concat(e.leftSE.point.x, ', ')
                  .concat(e.leftSE.point.y, '] -> ') + '['.concat(e.rightSE.point.x, ', ')
                  .concat(e.rightSE.point.y, '] ') + 'in SweepLine tree. Please submit a bug report.');
            ...
            return i(e, [{
              key: 'run', value: function(t, e, i) {
                ...
                for (var b = new V(f), k = f.size, M = f.pop(); M;) {
                  ...
                  if (f.size === k) {
                    var C = w.segment;
                    throw new Error('Unable to pop() '.concat(w.isLeft ? 'left' : 'right', ' SweepEvent ') + '['.concat(w.point.x, ', ')
                      .concat(w.point.y, '] from segment #')
                      .concat(C.id, ' ') + '['.concat(C.leftSE.point.x, ', ')
                      .concat(C.leftSE.point.y, '] -> ') + '['.concat(C.rightSE.point.x, ', ')
                      .concat(C.rightSE.point.y, '] from queue. ') + 'Please file a bug report.');
                  }
      ...
      t.exports = function() {
        ...
        function t(t, n, r, a, o) {
          !function s(t, i, n, r, a) {
            for (; r > n;) {
              if (r - n > 600) {
                var o = r - n + 1, l = i - n + 1, h = Math.log(o), u = .5 * Math.exp(2 * h / 3),
        ...
        return n.prototype.all = function() {
          ...
          for (var n = this.toBBox, r = []; e;) {
            for (var a = 0; a < e.children.length; a++) {
              var o = e.children[a], s = e.leaf ? n(o) : o;
          ...
          for (var i = []; e;) {
            for (var n = 0; n < e.children.length; n++) {
              var r = e.children[n], a = e.leaf ? this.toBBox(r) : r;
              if (d(t, a)) {
          ...
          var l = Math.ceil(o / s), h = l * Math.ceil(Math.sqrt(s));
          ...
          var n = i ? t : this.toBBox(t), r = [], a = this._chooseSubtree(n, this.data, e, r);
          ...
          var i = t[e], n = i.children.length, r = this._minEntries;
          this._chooseSplitAxis(i, r, n);
          var o = this._chooseSplitIndex(i, r, n), s = f(i.children.splice(o, i.children.length - o));
          ...
          for (var n, r, a, s, l, h, c, p = 1 / 0, d = 1 / 0, f = e; f <= i - e; f++) {
            var g = o(t, 0, f, this.toBBox), _ = o(t, f, i, this.toBBox),
          ...
          var n = t.leaf ? this.compareMinX : l, r = t.leaf ? this.compareMinY : h;
