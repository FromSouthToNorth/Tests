    ...
    var t = {
        9705: (t, e, i) => {
            ...
            e.coordAll = function (t) {
                ...
                var i, r = e.featureIndex || 0, a = e.multiFeatureIndex || 0, o = e.geometryIndex || 0,
                    s = e.coordIndex || 0, l = e.properties;
                switch (t.type) {
                    case"FeatureCollection":
                ...
                if (e = e || {}, !n.isObject(e)) throw new Error("options is invalid");
                var i, r = e.featureIndex || 0, a = e.multiFeatureIndex || 0, o = e.geometryIndex || 0,
                    s = e.segmentIndex || 0, l = e.properties;
                switch (t.type) {
                    case"FeatureCollection":
                        r < 0 && (r = t.features.length + r), l = l || t.features[r].properties, i = t.features[r].geometry;
                        break;
            ...
            var et = {
                _initSnappableMarkers: function () {
                    ...
                    var i = this, n = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1, r = [],
                        a = {};
                    ...
                    var i = this._map, n = e instanceof L.Marker || e instanceof L.CircleMarker,
                        r = e instanceof L.Polygon, a = t;
                    if (n) {
                        var o = e.getLatLng();
            ...
            nt.Line = nt.extend({
                initialize: function (t) {
                    ...
                    if (t.length <= 1) this.disable(); else {
                        var e = this._layer.getLatLngs(), i = t[t.length - 1],
                ...
                initialize: function (t) {
                    ...
                    var t = this, e = V(this._startMarker.getLatLng(), this._map),
                ...
                initialize: function (t) {
                    ...
                    var t = this._centerMarker.getLatLng(), e = this._hintMarker.getLatLng(),
                    ...
                    if (!this.options.requireSnapToFinish || this._hintMarker._snapped || this._isFirstLayer()) {
                        this._hintMarker._snapped || this._hintMarker.setLatLng(t.latlng);
                        var e = this._centerMarker.getLatLng(), i = this._hintMarker.getLatLng(),
            ...
            function jt(t, e) {
                ...
                var r = i[0][0], a = i[0][1], o = i[1][0], s = i[1][1], l = n[0][0], h = n[0][1], u = n[1][0],
                    c = n[1][1], p = (c - h) * (o - r) - (u - l) * (s - a), d = (u - l) * (a - h) - (c - h) * (r - l),
                    f = (o - r) * (a - h) - (s - a) * (r - l);
                if (0 === p) return null;
                var g = d / p, _ = f / p;
                            ...
                            n.forEach((function (t) {
                                if (t && t.snapInfo) {
                                    ...
                                    if (n && n.segment && n.distance < e.options.snapDistance) {
                                        var o = n.segment;
                                        if (o && 2 === o.length) {
                                            var s = L.PM.Utils._getIndexFromSegment(a, o), l = s.indexPath,
                                                h = s.parentPath, u = s.newIndex;
            ...
            var Me = {
                _onRotateStart: function (t) {
                    ...
                    var e = be(this._map, t.target.getLatLng()), i = this._rotationStartPoint,
                    ...
                    if (this.options.allowRotation) {
                        this._rotatePoly = L.polygon(this._layer.getLatLngs(), {
                            ...
                            snappable: !1,
                            hideMiddleMarkers: !0
                        }), this._rotatePoly.pm._rotationLayer = this._layer, this._rotatePoly._pmTempLayer = !0, this._rotatePoly.pm.enable(), this._rotateOrgLatLng = U(this._layer), this._rotateEnabled = !0, this._layer.on("remove", this.disableRotate, this), this._fireRotationEnable(this._layer), this._fireRotationEnable(this._layer._map)
            ...
            we.Line = we.extend({
                includes: [Ee], _shape: "Line", initialize: function (t) {
                    ...
                    var i = L.PM.Utils.calcMiddleLatLng(this._map, t.getLatLng(), e.getLatLng()),
                        n = this._createMarker(i), r = L.divIcon({className: "marker-icon marker-icon-middle"});
                    ...
                    var a = L.PM.Utils.findDeepMarkerIndex(this._markers, e), o = a.indexPath, s = a.index,
                        l = a.parentPath, h = o.length > 1 ? B()(r, l) : r,
                    ...
                    if (this._vertexValidation("remove", t)) {
                        ...
                        var i = this._layer.getLatLngs(), n = L.PM.Utils.findDeepMarkerIndex(this._markers, e),
                    ...
                    var e = this._layer.getLatLngs(), i = t.getLatLng(),
                        n = L.PM.Utils.findDeepMarkerIndex(this._markers, t), r = n.indexPath, a = n.index,
                        o = n.parentPath;
                    (r.length > 1 ? B()(e, o) : e).splice(a, 1, i), this._layer.setLatLngs(e)
                }, _getNeighborMarkers: function (t) {
                    var e = L.PM.Utils.findDeepMarkerIndex(this._markers, t), i = e.indexPath, n = e.index,
                        r = e.parentPath, a = i.length > 1 ? B()(this._markers, r) : this._markers,
                        o = (n + 1) % a.length;
                    ...
                    if (this._vertexValidationDrag(e)) {
                        var i = L.PM.Utils.findDeepMarkerIndex(this._markers, e), n = i.indexPath, r = i.index,
                            a = i.parentPath;
                        if (n) {
                            ...
                            var o = n.length > 1 ? B()(this._markers, a) : this._markers, s = (r + 1) % o.length,
                                l = (r + (o.length - 1)) % o.length, h = e.getLatLng(), u = o[l].getLatLng(),
                                c = o[s].getLatLng();
            ...
            var Ie = {
                calcMiddleLatLng: function (t, e, i) {
                    ...
                    var i, n = !(arguments.length > 2 && arguments[2] !== undefined) || arguments[2],
                        r = function o(t) {
                            return function (r, a) {
                                var s = t.concat(a);
                                if (n) {
            ...
            var n = i(3560), r = i(5346), a = i(3218), o = i(346), s = /^\[object .+?Constructor\]$/,
                l = Function.prototype, h = Object.prototype, u = l.toString, c = h.hasOwnProperty,
            ...
            var n = i(2705), r = Object.prototype, a = r.hasOwnProperty, o = r.toString,
            ...
            t = i.nmd(t);
            var n = i(1957), r = e && !e.nodeType && e, a = r && t && !t.nodeType && t,
                o = a && a.exports === r && n.process, s = function () {
                    try {
                ...
                var L = v * v, b = function (t, e) {
                        ...
                        return i(e, null, [{
                            key: "compare", value: function (t, e) {
                                var i = t.leftSE.point.x, n = e.leftSE.point.x, r = t.rightSE.point.x,
                                    a = e.rightSE.point.x;
                                if (a < i) return 1;
                                if (r < n) return -1;
                                var o = t.leftSE.point.y, s = e.leftSE.point.y, l = t.rightSE.point.y,
                                    h = e.rightSE.point.y;
                                if (i < n) {
                                    if (s < o && s < l) return 1;
                                    if (s > o && s > l) return -1;
                            ...
                            key: "split", value: function (t) {
                                var i = [], n = t.events !== undefined, r = new T(t, !0), a = new T(t, !1),
                                    o = this.rightSE;
